...
function FreelancerOnboarding({ onComplete }: FreelancerOnboardingProps) {
  ...
  const steps = [
    { number: 1, title: 'Upload Details', icon: Upload, component: UploadDetails },
    { number: 2, title: 'Create Profile', icon: UserCircle, component: CreateProfile },
    { number: 3, title: 'Verification', icon: ShieldCheck, component: Verification }
  ]
